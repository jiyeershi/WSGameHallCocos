...
--Button class will be Deprecated,begin
function DeprecatedExtensionClass.Button()
    deprecatedTip("Button","ccs.Button")
    return ccs.Button
end
_G["Button"] = DeprecatedExtensionClass.Button()
--Button class will be Deprecated,end
